...
# Model architecture
ASPECT_RATIO = 64# model_dim = depth * ASPECT_RATIO (increased from 48 for depth=12 to get clean 6-head config)
...
# Model size
DEPTH = 12              # number of transformer layers (increased from 10 for more capacity)
