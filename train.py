...
class GPT(nn.Module):
    ...
    def init_weights(self):
        # Embedding and unembedding (tied weights: lm_head shares wte.weight)
    ...
    def num_scaling_params(self):
        # Note: lm_head.weight is tied to wte.weight, so only count once
...
# Model size
DEPTH = 10               # number of transformer layers (matching proven-best architecture n_embd=640)
